...
const Home = () => {
    ...
    return (
			<div>
				...
				<div id="hero" className="h-svh flex flex-col justify-between pt-24">
					<div className="flex justify-between px-24 pt-24 font-cormorant text-grey">
						...
						<div className="w-2/3 flex gap-20">
							<div className="w-7/12 text-xl font-light">
								...
								<em className="italic font-semibold">old age home</em> in
								Mysore, providing shelter and care to a number of elderly
								residents. Additionally, the trust is actively engaged in the{" "}
							...
							<div className="w-5/12 text-xl font-light">
								If you share the vision of a compassionate and inclusive
								society, please consider supporting the
				...
				<div id="origin" className="h-svh flex justify-center">
					<div className="w-1/3 flex flex-col justify-center items-center ">
						...
						<h4 className="font-cormorant font-normal text-terracotta text-3xl text-center">
							The <em className="italic font-light">Heartfelt Journey</em>{" "}
							<br /> Behind This Foundation
						</h4>
						<p className="font-cormorant font-medium text-grey text-xl mt-12 text-center">
							...
							retired Principal from the Directorate of Education, Government of
							N.C.T. of Delhi, and Mrs. Ganga Bhat, a retired officer from a
							nationalized bank, established this Trust out of deep compassion
							and a spirit of seva. Being parents to two autistic sons, they
							witnessed firsthand the struggles faced by Divyang individuals and
							the downtrodden, often compounded by society&apos;s apathy. Moved
							by these experiences and driven by a desire to serve, they
						...
						<p className="font-cormorant font-medium text-grey text-xl text-center mt-8">
							...
							beacon of hope, striving to foster inclusion, dignity, and care
				...
				>
					<div className="w-1/3 py-14 px-20 bg-offwhite">
						...
						<p className="font-cormorant font-light text-grey text-xl mt-4">
							...
							togetherness, and shared purpose. It&apos;s a sanctuary where
							lives blossom, values are nurtured, and the spirit of seva binds
							everyone in a tapestry of love and harmony.
						</p>
					</div>
				</div>
				...
				>
					<div className="w-1/3 bg-offwhite px-16 py-16 flex flex-col items-center justify-between h-2/3">
						<h6 className="font-cormorant font-light text-terracotta text-xl">
						...
						<p className="font-cormorant font-light text-grey text-xl text-center">
							...
							Sindhuvalli Panchayath, Jayapura Hobli, Mysuru Taluk. The land is
							8 km from Mysuru Airport and 5 km from Kadakola &#40;Mysuru-Ooty
							National Highway&#41;.
						</p>
						<a
				...
				<div
					id="building"
					className="h-svh bg-terracotta bg-building-bg flex w-full justify-between"
					ref={outerRef}
				>
					<div className="flex flex-col w-1/2 px-24 py-24 justify-between">
						...
						<div
							...
							ref={innerRef}
							className=" scroll font-cormorant font-light text-offwhite text-xl  h-1/2 px-2 overflow-y-scroll overflow-x-visible"
						>
					...
					<div className="w-1/2 flex flex-col items-center mt-36 gap-8">
						...
						<div className="flex gap-8 font-cormorant font-normal text-grey text-xl text-justify">
							<p>
								...
								mind here is unique, and every dream is possible with the
								strength of community and a commitment to learning.
							</p>
							<p>
								In the spirit of ancient Indian wisdom, we dream of creating a
								humble sanctuary—a true aangan—where our elders are not just
								cared for but deeply cherished. Here, every wrinkle tells a
								story, every laugh is a blessing, and every soul is honored with
								respect. This vision is more than a place; it is a space of
								warmth, joy, and dignity, where age is not a burden but a
								treasure.
							</p>
						</div>
					</div>
						...
						<div className="flex flex-col font-cormorant text-xl italic">
							...
							<div className="flex">
								...
								<div className="border border-grey w-2/3 py-2 px-2 font-semibold text-terracotta">
									Office of the Registrar of the Companies, Ministry of
